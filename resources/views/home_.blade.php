        ...
        <div class="intro-section bg-lighter pt-5 pb-6">
            ...
            <div class="container">
                <div class="intro-slider owl-carousel owl-simple owl-light owl-nav-inside mb-5" data-toggle="owl"
                    ...
                    {{-- Slide 2 --}}
                    <div class="intro-slide position-relative" style="height: 600px; background: #000;">
                        <img src="{{ asset('assets/images/home/home_1.png') }}" alt="Abonnements"
                            style="object-fit: contain; object-position: center; width: 100%; height: 100%; background-color: #000;">
                    ...
                    {{-- Slide 3 --}}
                    <div class="intro-slide position-relative" style="height: 600px; background: #000;">
                        <img src="{{ asset('assets/images/home/chat-bg.jpg') }}" alt="Nettoyage"
                            style="object-fit: contain; object-position: center; width: 100%; height: 100%; background-color: #000;">
        ...
        <section class="blog-section py-5 bg-light">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted mx-auto" style="max-width: 600px;">Découvrez les dernières informations, conseils
                        pratiques et nouveautés autour de la gestion d’abonnements.</p>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Les abonnements non suivis entraînent des pertes. Voici comment une
                                    bonne gestion peut vous faire économiser...</p>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">SubSure propose des rappels automatiques pour ne plus jamais oublier
                                    vos paiements de contrat ou de service...</p>
                                <a href="#" class="btn btn-link text-primary">Lire plus</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Découvrez les erreurs les plus fréquentes que font les entreprises et
                                    comment les éviter grâce à une plateforme dédiée...</p>
                                <a href="#" class="btn btn-link text-primary">Lire plus</a>
                            </div>
                        </div>
                    </div>
