            ...
            <div class="container">
                <div class="intro-slider owl-carousel owl-simple owl-light owl-nav-inside mb-5" data-toggle="owl"
                    ...
                    <div class="intro-slide position-relative" style="height: 600px; background: #000;">
                        <img src="{{ asset('assets/images/home/home_2.png') }}" alt="Bienvenue"
                ...
                background: rgba(0,0,0,0.4);"></div>
                        ...
                        <div
                            ...
                            <h3 class="intro-subtitle fs-4 mb-2">Bienvenue sur <span class="text-warning">SubSure</span>
                            </h3>
                    ...
                    {{-- Slide 2 --}}
                    <div class="intro-slide position-relative" style="height: 600px; background: #000;">
                        <img src="{{ asset('assets/images/home/img1.jpg') }}" alt="Abonnements"
                            style="object-fit: contain; object-position: center; width: 100%; height: 100%; background-color: #000;">
                ...
                background: rgba(0,0,0,0.4);"></div>
                        ...
                        <div
                            class="intro-content position-absolute top-50 start-50 translate-middle text-white text-center">
                            <h3 class="intro-subtitle fs-4 mb-2">Tout en un clic</h3>
                    ...
                    {{-- Slide 3 --}}
                    <div class="intro-slide position-relative" style="height: 600px; background: #000;">
                        <img src="{{ asset('assets/images/home/img2.jpg') }}" alt="Nettoyage"
                            style="object-fit: contain; object-position: center; width: 100%; height: 100%; background-color: #000;">
                ...
                background: rgba(0,0,0,0.4);"></div>
                        ...
                        <div
                            class="intro-content position-absolute top-50 start-50 translate-middle text-white text-center">
                            <h3 class="intro-subtitle fs-4 mb-2">Suivi des Contrats et Abonnements Clients</h3>
                        ...
                        <div class="product product-11 text-center shadow-sm p-3 bg-light rounded-3">
                            <figure class="product-media mb-3">
                                <a href="{{ url('/details/' . $service['id']) }}">
                                    <img src={{ env('API_BASE_URL') . '/service_image/' . $service['image'] }}
                                        alt="Image du Service" class="img-fluid rounded">
                                </a>
                            </figure>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg border-0 h-100 p-4">
                            ...
                            <p class="card-text">Gérez jusqu’à 3 services avec alertes simples. Idéale pour les
                                particuliers.</p>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg border-0 h-100 p-4">
                            ...
                            <p class="card-text">Gérez jusqu’à 10 services avec rappels automatiques, PDF, et support
                                prioritaire.</p>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-lg border-0 h-100 p-4">
                            ...
                            <p class="card-text">Nombre illimité de services, tableaux de bord, utilisateurs multiples, et
                                plus.</p>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="p-4 bg-white shadow-sm rounded">
                            <p class="fst-italic">"SubSure m’a évité plusieurs pénalités de retard. Simple et efficace !"
                            </p>
                    ...
                    <div class="col-md-4">
                        <div class="p-4 bg-white shadow-sm rounded">
                            <p class="fst-italic">"Notre entreprise gère mieux ses abonnements grâce à leur tableau de
                                bord."</p>
            ...
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted mx-auto" style="max-width: 600px;">
                        Découvrez les dernières informations, conseils pratiques et nouveautés autour de la gestion
                        d’abonnements.
                    </p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    Les abonnements non suivis entraînent des pertes. Voici comment une bonne gestion peut
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    SubSure propose des rappels automatiques pour ne plus jamais oublier vos paiements de
                                    contrat ou de service...
                                </p>
                                <a href="https://www.service-public.fr/particuliers/actualites/A15894" target="_blank"
                                    class="btn btn-link text-primary">Lire plus</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <img src="{{ asset('assets/images/home/ab_5.jpeg') }}" class="card-img-top"
                                alt="Erreurs à éviter">
                            <div class="card-body">
                                <h5 class="card-title">Top 5 des erreurs de gestion des contrats</h5>
                                <p class="card-text">
                                    Découvrez les erreurs les plus fréquentes que font les entreprises et comment les éviter
